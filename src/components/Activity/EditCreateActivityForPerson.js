...
class EditCreateActivityForPerson extends Component {
    ...
    onSubmit = (formValue) => {
        ...
        activity.organizationId = this.props.person.organizationId;
...
const selector = formValueSelector('postNewActivityForPersonForm') // <-- same as form name
...
export default reduxForm({
    form: 'postNewActivityForPersonForm',
    validate, // <--- validation function given to redux-form
    enableReinitialize: true
})(
    connect(mapStateToProps, {create, update, _delete})(EditCreateActivityForPerson)
);