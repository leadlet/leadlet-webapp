...
export const ContactSummary = function(props){

    const { contact, onEditClicked } = props;
                ...
                <div className="text-center">
                    ...
                    <div className="contact-box-footer">
                        <div className="m-t-xs btn-group">
                            <a onClick={()=> onEditClicked(contact)} className="btn btn-xs btn-white"><i className="fa fa-pencil"></i> Edit </a>
